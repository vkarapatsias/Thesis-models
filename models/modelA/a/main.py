...
"""
calculations(input_ss, output, 0, 0, "results/a/ss/fixed")
calculations(input_ss, output, 0, 1, "results/a/ss/adaptive")
calculations(input_ss, output, 1, 0, "results/b/ss/fixed")
calculations(input_ss, output, 1, 1, "results/b/ss/adaptive")

calculations(input_rs, output, 0, 0, "results/a/rs/fixed")
calculations(input_rs, output, 0, 1, "results/a/rs/adaptive")
calculations(input_rs, output, 1, 0, "results/b/rs/fixed")
calculations(input_rs, output, 1, 1, "results/b/rs/adaptive")
"""
calculations(input, output, 0, 0, "results/a/rs/fixed")
calculations(input, output, 0, 1, "results/a/rs/adaptive")
calculations(input, output, 1, 0, "results/b/rs/fixed")
calculations(input, output, 1, 1, "results/b/rs/adaptive")
