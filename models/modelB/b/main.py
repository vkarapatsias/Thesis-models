...
calculations(input_ss,output,0, "results/rs/input/fixed")
calculations(input_ss,output_rs,0, "results/rs/both/fixed")
calculations(input_ss,output,1, "results/rs/input/adaptive")
calculations(input_ss,output_rs,1, "results/rs/both/adaptive")
