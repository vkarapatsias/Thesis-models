...
class phase2():
        ...
        def calculations(self):
            ...
            for omega in Omega_grid:
                ...
                kernel_train_full = temp_obj.smkl.get_combined_kernel()
                for g in ParameterGrid(param_grid):
                    ...
                    for kk in range(kernel_train_full.shape[0]):
                        ...
                        train_indexes = np.asarray(range(kernel_train_full.shape[0]))
            ...
            combo_align = self.best.smkl.score(self.baseKernels, self.ytrain, phase = 2)
            ...
            a.append(best_omega)
            a = np.asarray(a)
            rmse, CVrmse, mae = self.best.stats(self.xtest,self.ytest)
            self.data = [self.Rold, self.Rnew, rmse, CVrmse, mae, a[0], a[1], a[2], combo_align]
