...
calculations(input_ss, output, 0, 0, "results/a/ss/input/fixed")
calculations(input_ss, output_ss, 0, 0, "results/a/ss/both/fixed")
calculations(input_ss, output, 0, 1, "results/a/ss/input/adaptive")
calculations(input_ss, output_ss, 0, 1, "results/a/ss/both/adaptive")
calculations(input_ss, output, 1, 0, "results/b/ss/input/fixed")
calculations(input_ss, output_ss, 1, 0, "results/b/ss/both/fixed")
calculations(input_ss, output, 1, 1, "results/b/ss/input/adaptive")
calculations(input_ss, output_ss, 1, 1, "results/b/ss/both/adaptive")

calculations(input_rs, output, 0, 0, "results/a/rs/input/fixed")
calculations(input_rs, output_rs, 0, 0, "results/a/rs/both/fixed")
calculations(input_rs, output, 0, 1, "results/a/rs/input/adaptive")
calculations(input_rs, output_rs, 0, 1, "results/a/rs/both/adaptive")
calculations(input_rs, output, 1, 0, "results/b/rs/input/fixed")
calculations(input_rs, output_rs, 1, 0, "results/b/rs/both/fixed")
calculations(input_rs, output, 1, 1, "results/b/rs/input/adaptive")
calculations(input_rs, output_rs, 1, 1, "results/b/rs/both/adaptive")
